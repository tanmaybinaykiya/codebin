<div class="gravitonFeedback long-form">
<?php echo $form->create('GravitonFeedback', array('url' => array('controller' => 'graviton_teams', 'action' => 'feedback'), 'class' => 'long-form'));?>
	<fieldset>
 		<legend><?php __('Graviton Workshop Series: Feedback Form');?></legend>
	<?php
		...
		echo $form->input('comments', array('label' => 'Suggestions/Comments'));
	?>
	</fieldset>
