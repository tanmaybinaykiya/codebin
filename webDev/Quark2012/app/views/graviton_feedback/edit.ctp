...
<?php echo $form->create('GravitonFeedback');?>
	<fieldset>
 		<legend><?php __('Edit GravitonFeedback');?></legend>
	<?php
		echo $form->input('id');
...
<div class="actions">
	<ul>
		<li><?php echo $html->link(__('Delete', true), array('action'=>'delete', $form->value('GravitonFeedback.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $form->value('GravitonFeedback.id'))); ?></li>
