...
function RenderCssCal(bNewCal) {
	...
	if (Cal.Scroller=="DROPDOWN") {
		...
		for (i = 2000; i < (dtToday.getFullYear() + 2);i++)	{
  ...
  //******************End Month and Year selector in arrow******************************
...

	{
        ...
        vCalTime+="<img onmousedown='javascript:closewin(\"" + Cal.Ctrl + "\");' src='/master/scripts/cal_close.gif' width='16' height='14' onmouseover='changeBorder(this, 0)' onmouseout='changeBorder(this, 1)' style='border:1px solid white'></td>";
