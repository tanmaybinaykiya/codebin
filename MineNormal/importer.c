...
void addNormal(int fIndex){
	vertex a,b;
	a.x=vertices[faces[fIndex].vert1].x-vertices[faces[fIndex].vert2].x;
	a.y=vertices[faces[fIndex].vert1].y-vertices[faces[fIndex].vert2].y;
	a.z=vertices[faces[fIndex].vert1].z-vertices[faces[fIndex].vert2].z;

	b.x=vertices[faces[fIndex].vert3].x-vertices[faces[fIndex].vert2].x;
	b.y=vertices[faces[fIndex].vert3].y-vertices[faces[fIndex].vert2].y;
	b.z=vertices[faces[fIndex].vert3].z-vertices[faces[fIndex].vert2].z;

	normal[fIndex].x=a.y*b.z-a.z-b.y;
	normal[fIndex].y=a.z*b.x-a.x-b.z;
	normal[fIndex].z=a.x*b.y-a.y-b.x;
	
	float norm;
	norm=((normal[fIndex].x)*(normal[fIndex].x)+(normal[fIndex].y)*(normal[fIndex].y)+(normal[fIndex].z)*(normal[fIndex].z));
	norm=sqrt(norm);

	normal[fIndex].x=(normal[fIndex].x/norm)-1;
	normal[fIndex].y=(normal[fIndex].y/norm)-1;
	normal[fIndex].z=(normal[fIndex].z/norm)-1;
