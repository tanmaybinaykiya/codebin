...
//		printf("j=%d And (%f, %f, %f) \n",j,edgePoints[j][0],edgePoints[j][1],edgePoints[j][2] );
	...
	while(j<3){
		vertexPoints[j][0]=(  ((5/4)*vertices[v][0])  +  (edgePoints[i][0]+edgePoints[i+1][0]+edgePoints[i+8][0]+edgePoints[i+11][0])  +  (facePoints[k][0]+facePoints[k+1][0]+facePoints[k+4][0]+facePoints[k+5][0])  )  /4;
		vertexPoints[j][1]=(  ((5/4)*vertices[v][1])  +  (edgePoints[i][1]+edgePoints[i+1][1]+edgePoints[i+8][1]+edgePoints[i+11][1])  +  (facePoints[k][1]+facePoints[k+1][1]+facePoints[k+4][1]+facePoints[k+5][1])  )  /4;
		vertexPoints[j][2]=(  ((5/4)*vertices[v][2])  +  (edgePoints[i][2]+edgePoints[i+1][2]+edgePoints[i+8][2]+edgePoints[i+11][2])  +  (facePoints[k][2]+facePoints[k+1][2]+facePoints[k+4][2]+facePoints[k+5][2])  )  /4;
	...
	while(j<6)
	{
		vertexPoints[j][0]=(  ((5/4)*vertices[v+9][0])  +  (edgePoints[i][0]+edgePoints[i+1][0]+edgePoints[i+7][0]+edgePoints[i+10][0])  +  (facePoints[k][0]+facePoints[k+1][0]+facePoints[k+4][0]+facePoints[k+5][0])  )  /4;
		vertexPoints[j][1]=(  ((5/4)*vertices[v+9][1])  +  (edgePoints[i][1]+edgePoints[i+1][1]+edgePoints[i+7][1]+edgePoints[i+10][1])  +  (facePoints[k][1]+facePoints[k+1][1]+facePoints[k+4][1]+facePoints[k+5][1])  )  /4;
		vertexPoints[j][2]=(  ((5/4)*vertices[v+9][2])  +  (edgePoints[i][2]+edgePoints[i+1][2]+edgePoints[i+7][2]+edgePoints[i+10][2])  +  (facePoints[k][2]+facePoints[k+1][2]+facePoints[k+4][2]+facePoints[k+5][2])  )  /4;
